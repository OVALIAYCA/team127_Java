...
public class C06_DateTimeFormatter {
    ...
    public static void main(String[] args) {
        ...
        /*
        Yazdığımız kodlarda zaman veya tarih ile ilgili işlemlerde
        tarih veya zamanı istediğimiz formatta tutabilmek için
        DateTimeFormatter Class'ını kullanabiliriz
         */

        LocalDateTime ldt = LocalDateTime.now();
        System.out.println(ldt); // 2023-10-03T11:41:12.667750

        // saati 09:55 AM şeklinde yazdıralım

        DateTimeFormatter istenenSaatFormati1 = DateTimeFormatter.ofPattern("hh:mm a");
        System.out.println(ldt.format(istenenSaatFormati1)); // 08:59 ÖÖ


        DateTimeFormatter istenenSaatFormati2 = DateTimeFormatter.ofPattern("H:mm");
        System.out.println(ldt.format(istenenSaatFormati2)); //9:00
