...
public class C03_LocalDate {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(localDate.minusYears(3).minusMonths(2).minusDays(5)); //2020-07-29
        ...
        System.out.println(dogumTarihi2.isBefore(dogumTarihi1)); // false

        System.out.println(localDate.lengthOfYear()); // 365
        System.out.println(dogumTarihi1.lengthOfYear()); // 366 artık yıl olduğu için
